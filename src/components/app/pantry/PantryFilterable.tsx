                ...
                return (
                  <tr key={i.id} className="hover:bg-nav-hover border-b border-border/50">
                    ...
                    <td className="px-4 py-3 text-right whitespace-nowrap space-x-2">
                      <button data-edit-pantry={i.id} className="text-primary hover:text-primary-hover text-xs font-medium cursor-pointer">Editar</button>
                      <button data-delete-pantry={i.id} className="text-danger hover:text-danger-hover text-xs font-medium cursor-pointer">Eliminar</button>
                    </td>
                  </tr>
                );
              })}

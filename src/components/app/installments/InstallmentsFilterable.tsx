  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        ...
        <button data-create="installments" className="hidden sm:block sm:shrink-0 px-3 py-2 text-sm font-medium rounded-lg bg-primary text-white hover:bg-primary-hover cursor-pointer">Nuevo plazo</button>
      </div>
                ...
                return (
                  <tr key={i.id} className="hover:bg-nav-hover border-b border-border/50">
                    ...
                    <td className="px-4 py-3 text-right whitespace-nowrap space-x-2">
                      <button data-edit-installments={i.id} className="text-primary hover:text-primary-hover text-xs font-medium cursor-pointer">{BTN_EDIT_TEXT}</button>
                      <button data-delete-installments={i.id} className="text-danger hover:text-danger-hover text-xs font-medium cursor-pointer">{BTN_DELETE_TEXT}</button>
                    </td>
                  </tr>
                );
              })}

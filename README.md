...
¿Quieres contribuir o montar tu propia instancia? Toda la documentación técnica (arquitectura, base de datos, API, componentes y guías de contribución) está en **[DOCS.md](DOCS.md)**.
